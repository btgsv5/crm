...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
        ...
        //不拦截的资源,自动放行
        if ("/login.jsp".equals(path) || "/settings/user/login.do".equals(path) || path.contains("regist")||"/users/saveRegist.do".equals(path)) {
            ...
            //如果user不为空，说明登陆过
            if (user!=null){
                if (path.contains("admin") && user.getIsAdmin()!=1){
